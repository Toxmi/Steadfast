...
import com.toxmi.steadfast.modules.customenchants.customs.UnbrokenChain;
...
public class CustomListener  implements Listener {
    ...
    private void registerCustoms() {
        for (String custom : customsList) {
            try {
                customs.put(custom.toLowerCase(), (CustomEnchant) Class.forName("com.toxmi.steadfast.modules.customenchants.customs." + custom).getDeclaredConstructor().newInstance());
