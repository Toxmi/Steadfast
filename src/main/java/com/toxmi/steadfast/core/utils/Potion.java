...
public class Potion {
     ...
     */
    public static void addPotionEffect(PotionEffectType type, Entity entity, int duration, int amplifier) {
        if (entity instanceof LivingEntity) {
            amplifier -= 1;
            duration *= 20;
            ((LivingEntity) entity).addPotionEffect(new PotionEffect(type, duration, amplifier));
        }
    }
     ...
     * @param amplifier What level of potion effect is added
     */
    public static void addPotionEffect(PotionEffectType type, Entity entity, double duration, int amplifier) {
        if (entity instanceof LivingEntity) {
            amplifier -= 1;
            duration *= 20;
     ...
     * @param amplifier What level of potion effect is added
     */
    public static void addPotionEffect(PotionEffectType type, Entity entity, int amplifier) {
        if (entity instanceof LivingEntity) {
            amplifier -= 1;
            ((LivingEntity) entity).addPotionEffect(new PotionEffect(type, -1, amplifier));
        }
    }
     ...
     */
    public static void removePotionEffect(PotionEffectType type, Entity entity) {
        if (entity instanceof LivingEntity) {
     ...
     */
    public static void clearPotionEffects(Entity entity) {
        if (entity instanceof LivingEntity) {
            ((LivingEntity) entity).clearActivePotionEffects();
        }
    }
